...
pub fn solve() -> DayData {
    let part1_answer = part1::solve(INPUT.trim());
    let part2_answer = part2::solve(INPUT.trim());

    DayData {
        name: "Day 3: Binary Diagnostic".to_string(),
        part1_answer: part1_answer.to_string(),
        part1_correct: part1_answer == EXPECTED_PART1.trim(),
        part2_answer: part2_answer.to_string(),
        part2_correct: part2_answer == EXPECTED_PART2.trim(),
    }
}
